...
本節は、**2026-04-24 時点のコード実装そのもの**を基準に、スコア対象55 SCがどの scan / 補助ロジックで判定されるかを要約したものです。
...
- `manualCheckItems` は UI 上 48 件ですが、スコア母数は `WCAG_SC` の **55 SC** を使用しています。
...
**ツール全体として WCAG 2.2 A/AA 55 SC のうち:**
